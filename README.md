...
** Это сайт-приложение Flask, который анализирует страницы на SEO-пригодность **
...
Перейдите по образовавшейся в терминале ссылке
...
с краткой информацией. Здесь же можно перейти к сайту по ссылки и увидеть его параметры подробнее.
